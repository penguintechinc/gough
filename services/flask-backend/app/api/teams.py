...
def get_team(team_id: int):
    ...
    if not member and current_user.has_role("admin"):
...
@auth_required()
def assign_resource(team_id: int):
...
@auth_required()
def list_resources(team_id: int):
...
@auth_required()
def unassign_resource(team_id: int, assignment_id: int):
